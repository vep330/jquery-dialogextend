(function () {
  ...
  $.widget("ui.dialogExtend", {
      ...
      _initStyles: function () {
          ...
          if (!$(".dialog-extend-css").length) {
              style = [
                  ...
                  '.ui-dialog.jqdx-state-maximized { position: fixed !important; left: 0 !important; top: 0 !important; width: auto !important; height: 99% !important; right: 0; }',
      ...
      _toggleButtons: function (newstate) {
          ...
          var $titleBar = $('.ui-dialog-titlebar', this._getDialogElement());
      ...
      minimize: function () {
          ...
          if (!fixedContainer.length) {
              fixedContainer = $('<div id="dialog-extend-fixed-container"></div>').appendTo("#page > .wrapper");
          }
