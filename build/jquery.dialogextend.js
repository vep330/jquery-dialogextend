  ...
  $.widget("ui.dialogExtend", {
    ...
    _initStyles: function() {
      ...
      if (!$(".dialog-extend-css").length) {
        ...
        style += '.ui-dialog.jqdx-state-collapsed { height: auto !important; }';
        ...
        style += '#dialog-extend-fixed-container > .ui-dialog { position: static !important; width: auto !important; height: auto !important;}';
        // pad out titlebar to make enough space for extra icon buttons (absolute-positioned => no natural size)
        style += '#dialog-extend-fixed-container > .ui-dialog .ui-dialog-titlebar { padding-right: 7em; }';
        // defeat direct element style with !important
